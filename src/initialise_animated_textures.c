...
void	initialise_animated_textures(t_data *data)
{
	...
	data->anim2[1] = mlx_load_png("./texture/eyes/eyes_02.png");
	// data->anim2[3] = mlx_load_png("./texture/eyes/eyes_03.png");
	data->anim2[2] = mlx_load_png("./texture/eyes/eyes_04.png");
	// data->anim2[5] = mlx_load_png("./texture/eyes/eyes_05.png");
	data->anim2[3] = mlx_load_png("./texture/eyes/eyes_06.png");
	// data->anim2[7] = mlx_load_png("./texture/eyes/eyes_07.png");
	data->anim2[4] = mlx_load_png("./texture/eyes/eyes_08.png");
	// data->anim2[9] = mlx_load_png("./texture/eyes/eyes_09.png");
	data->anim2[5] = mlx_load_png("./texture/eyes/eyes_10.png");
	// data->anim2[11] = mlx_load_png("./texture/eyes/eyes_11.png");
	data->anim2[6] = mlx_load_png("./texture/eyes/eyes_12.png");
	// data->anim2[13] = mlx_load_png("./texture/eyes/eyes_13.png");
	data->anim2[7] = mlx_load_png("./texture/eyes/eyes_14.png");
	// data->anim2[15] = mlx_load_png("./texture/eyes/eyes_15.png");
	data->anim2[8] = mlx_load_png("./texture/eyes/eyes_16.png");
	// data->anim2[17] = mlx_load_png("./texture/eyes/eyes_17.png");
	data->anim2[9] = mlx_load_png("./texture/eyes/eyes_18.png");
	// data->anim2[19] = mlx_load_png("./texture/eyes/eyes_19.png");
	data->anim2[10] = mlx_load_png("./texture/eyes/eyes_20.png");
	// data->anim2[21] = mlx_load_png("./texture/eyes/eyes_21.png");
	data->anim2[11] = mlx_load_png("./texture/eyes/eyes_22.png");
	// data->anim2[23] = mlx_load_png("./texture/eyes/eyes_23.png");
	data->anim2[12] = mlx_load_png("./texture/eyes/eyes_24.png");
	if (
	...
	data->anim3[2] = mlx_load_png("./texture/crab/crab_03.png");
	data->anim3[3] = mlx_load_png("./texture/crab/crab_04.png");
	// data->anim3[5] = mlx_load_png("./texture/crab/crab_05.png");
	data->anim3[4] = mlx_load_png("./texture/crab/crab_06.png");
	data->anim3[5] = mlx_load_png("./texture/crab/crab_07.png");
	// data->anim3[8] = mlx_load_png("./texture/crab/crab_08.png");
	data->anim3[6] = mlx_load_png("./texture/crab/crab_09.png");
	data->anim3[7] = mlx_load_png("./texture/crab/crab_10.png");
	// data->anim3[11] = mlx_load_png("./texture/crab/crab_11.png");
	data->anim3[8] = mlx_load_png("./texture/crab/crab_12.png");
	data->anim3[9] = mlx_load_png("./texture/crab/crab_13.png");
	// data->anim3[14] = mlx_load_png("./texture/crab/crab_14.png");
	data->anim3[10] = mlx_load_png("./texture/crab/crab_15.png");
	data->anim3[11] = mlx_load_png("./texture/crab/crab_16.png");
	// data->anim3[17] = mlx_load_png("./texture/crab/crab_17.png");
	data->anim3[12] = mlx_load_png("./texture/crab/crab_18.png");
	data->anim3[13] = mlx_load_png("./texture/crab/crab_19.png");
	// data->anim3[20] = mlx_load_png("./texture/crab/crab_20.png");
	data->anim3[14] = mlx_load_png("./texture/crab/crab_21.png");
	data->anim3[15] = mlx_load_png("./texture/crab/crab_22.png");
